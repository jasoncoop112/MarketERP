    ...
    const seedData = async () => {
      ...
      if (pCount === 0) {
        ...
        await db.customers.bulkAdd([
          { name: '散客', phone: '-', debt: 0, totalSpent: 0, bucketsOut: 0, bucketsIn: 0, createdAt: new Date().toISOString() },
          { name: '王老板 (火锅店)', phone: '13800138000', debt: 1200, totalSpent: 8500, bucketsOut: 50, bucketsIn: 40, createdAt: new Date().toISOString() },
          { name: '李阿姨 (菜场零售)', phone: '13912345678', debt: 0, totalSpent: 2300, bucketsOut: 10, bucketsIn: 10, createdAt: new Date().toISOString() },
        ]);
      }
    };
    seedData();
